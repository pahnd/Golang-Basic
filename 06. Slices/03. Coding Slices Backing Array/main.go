...
func main() {
	...
	// biểu thức Slice không tạo ra mảng sao lưu mới. Lát ban đầu và lát được trả về được kết nối. Slice được trỏ vào chung 1 ô nhớ
	...
	// khi một slice được tạo bằng cách cắt một array, array đó sẽ trở thành mảng hỗ trợ của slice mới. slice sẽ trỏ tới ô nhớ của array
	...
	// Hàm append() tạo một lát cắt mới hoàn chỉnh từ một lát cắt hiện có

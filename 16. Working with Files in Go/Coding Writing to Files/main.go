...
func main() {
	...
	// Sử dụng module os sẽ import nhiều package dẫn đến tăng dung lượng file thực thi (Nhiều function không thực sự sử dụng đến). Sử dụng ghi byte sẽ thực thi đúng function ghi khi cần.
